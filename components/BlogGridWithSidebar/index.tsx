...
// تعريف نوع البيانات لفئة واحدة
interface Category {
  name: string;
  products: number;
}

// تعريف props لمكون Categories (تأكد أن مكون Categories يقبل هذه props)
...
const BlogGridWithSidebar: React.FC = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Blog Grid Sidebar" pageDescription="blog grid sidebar" />
