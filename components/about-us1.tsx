...
export default async function AboutUs1() {
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  {t("whyChoose.points.0")} <br />
                  {t("whyChoose.points.1")} <br />
                  {t("whyChoose.points.2")} <br />
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  {t("expertise.section1.title")} <br />
                  {t("expertise.section1.points.0")} <br />
                  {t("expertise.section1.points.1")} <br />
                  {t("expertise.section2.title")} <br />
                  {t("expertise.section2.points.0")} <br />
                  {t("expertise.section2.points.1")}
                </p>
              </div>
            </div>
          </div>
